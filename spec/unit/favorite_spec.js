...
describe("Favorite", () => {
 ...
 describe("#create()", () => {
    ...
    it("should create a favourite or a post on a user", (done) => {
        Favorite.create({
            postId: this.post.id,
            userId: this.user.id
        })
    ...
    it("should note createa favourite without assigned post or user", (done) => {
        Favorite.create({
            userId: null
        })
        .then((favorite) => {
 ...
 describe("#setPost()", () => {
    ...
    it("it should associate a post and a favorite together", (done) => {
        ...
        .then((favorite) => {
            ...
            Post.create({
                ...
                body: "Spacesuit, space helmet, sppace boots, and space gloves",
